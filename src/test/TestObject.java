...
import objects.materials.SuperFriction;
...
public class TestObject {
	public static void main(String[] args) throws InterruptedException{
		...
		ObjectDescription obj5 = FactoryObjectBox2D.createBox(20, 20, new SuperFriction(), visual2);
		...
		LevelDescriptor ld = new LevelDescriptor(new Vec2(0f,-20f));
...
//		Decorate ground1 = new Decorate(obj1);
		ArrayList<ObjectAdded> list_ground = new ArrayList<ObjectAdded>();
		list_ground.add(level.addObject("ground1", ground1, 0, 0, true));
		list_ground.add(level.addObject("ground2", ground2, 120, 0, true));
		list_ground.add(level.addObject("ground3", ground1, 400, 300, true));
		list_ground.add(level.addObject("ground5", ground3, 250, 0, true));
		...
		ObjectAdded ply = level.addObject("heri", hero, 270, 70, false);
		
		ActionGround ag = new ActionGround();
		ArrayList<ObjectAdded> plyArray = new ArrayList<ObjectAdded>();
		plyArray.add(ply);
		SensorCollision sc = new SensorCollision(list_ground, plyArray, ag);
		level.addSenor("System_sensor_ground", sc);
		
		UserEventListener userListener = new UserEventListener();
		ply.setDriver(new DriverObject(userListener, ply, ag));
...
//		frame7.add(view7);
		...
		GraphicsView view4 = new GraphicsView(level,ply, 1);
		...
		frame3.addKeyListener(userListener);
